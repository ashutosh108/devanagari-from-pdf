...
#	'\u007a':			'-.m',		# z
#	'\u007b':			'r-',		# { hook above line. adds r to the beninning os syllable
#	'\u007c':			'r-.m',		# | hook above + dot. adds r to the beinning and .m to the end
#	'\u007d':			'-r',		# } line from center to left-bottom
#	'\u007e':			'-r',		# ~ inverted caret below line (used in syllables not ending with bar)
#	'\u00a0':			'pt-',		# NBSP
#	'\u00a8':			'dbha',		# ¨
#	'\u00a9':			'dda',		# ©
#	'\u00ae':			'dba',		# ®
